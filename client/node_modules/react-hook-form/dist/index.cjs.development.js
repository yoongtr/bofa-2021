...
function useForm({ mode = VALIDATION_MODE.onSubmit, reValidateMode = VALIDATION_MODE.onChange, resolver, context, defaultValues = {}, shouldFocusError = true, criteriaMode, } = {}) {
    ...
    const setInternalValue = React.useCallback((name, value, options) => {
...
const FormProvider = (_a) => {
    ...
    return (React.createElement(FormContext.Provider, { value: props }, children));
};
...
const useFieldArray = ({ control, name, keyName = 'id', }) => {
    ...
    const [fields, setFields] = React.useState(mapIds(get(fieldArrayDefaultValuesRef.current, getFieldArrayParentName(name))
